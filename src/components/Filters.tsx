    ...
    <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center mx-p lg:x-p lg:py-11 py-7">
      ...
      <div className="relative lg:py-0 pt-10">
        <button
          ...
          className="flex justify-between items-center lg:w-[250px] dark:bg-darkblue bg-white text-lverydarkblue dark:text-white dark:font-light font-medium text-base lg:py-5 py-4 px-6 lg:mr-[17px] rounded-md dark:shadow-md shadow-[0px_6px_10px_0px_rgba(0,0,0,0.1),0px_2px_4px_0px_rgba(0,0,0,0.08)]"
